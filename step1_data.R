...
tiff(filename = "D://4.生物信息//R//生信//CAD-2//plot//1.1deg_pca.tiff", res = 300, width = 2500, height = 1800,compression = "lzw")
dev.off()
pdf(file = "D://4.生物信息//R//生信//CAD-2//plot//1.1deg_pca.pdf",width = 12, height = 8, onefile = FALSE)
dev.off()
tiff(filename = "D://4.生物信息//R//生信//CAD-2//plot//1.1deg_pca(3D).tiff", res = 300, width = 2500, height = 1800,compression = "lzw")
dev.off()
pdf(file = "D://4.生物信息//R//生信//CAD-2//plot//1.1deg_pca(3D).pdf",width = 10, height = 6.5, onefile = FALSE)
dev.off()
tiff(filename = "D://4.生物信息//R//生信//CAD-2//plot//1.2deg_vol.tiff", res = 300, width = 2500, height = 1800,compression = "lzw")
dev.off()
pdf(file = "D://4.生物信息//R//生信//CAD-2//plot//1.2deg_vol.pdf",width = 12, height = 8, onefile = FALSE)
dev.off()
tiff(filename = "D://4.生物信息//R//生信//CAD-2//plot//1.3deg_heat.tiff", res = 300, width = 2500, height = 1800,compression = "lzw")
dev.off()
pdf(file = "D://4.生物信息//R//生信//CAD-2//plot//1.3deg_heat.pdf",width = 12, height = 8, onefile = FALSE)
dev.off()
...
tiff(filename = "D://4.生物信息//R//生信//CAD-2//plot//3.1deg_Cu_pca.tiff", res = 300, width = 2500, height = 1800,compression = "lzw")
dev.off()
pdf(file = "D://4.生物信息//R//生信//CAD-2//plot//3.1deg_Cu_pca.pdf",width = 12, height = 8, onefile = FALSE)
dev.off()
tiff(filename = "D://4.生物信息//R//生信//CAD-2//plot//3.1deg_Cu_pca(3D).tiff", res = 300, width = 2500, height = 1800,compression = "lzw")
dev.off()
pdf(file = "D://4.生物信息//R//生信//CAD-2//plot//3.1deg_Cu_pca(3D).pdf",width = 10, height = 6.5, onefile = FALSE)
dev.off()
tiff(filename = "D://4.生物信息//R//生信//CAD-2//plot//3.2deg_Cu_vol.tiff", res = 300, width = 2500, height = 1800,compression = "lzw")
dev.off()
pdf(file = "D://4.生物信息//R//生信//CAD-2//plot//3.2deg_Cu_vol.pdf",width = 12, height = 8, onefile = FALSE)
dev.off()
tiff(filename = "D://4.生物信息//R//生信//CAD-2//plot//3.3deg_Cu_heat.tiff", res = 300, width = 2500, height = 1800,compression = "lzw")
dev.off()
pdf(file = "D://4.生物信息//R//生信//CAD-2//plot//3.3deg_Cu_heat.pdf",width = 12, height = 8, onefile = FALSE)
dev.off()
...
tiff(filename = "D://4.生物信息//R//生信//CAD-2//plot//4.co_deg.tiff", res = 300, width = 2000, height = 1000,compression = "lzw")
dev.off()
pdf(file = "D://4.生物信息//R//生信//CAD-2//plot//4.co_deg.pdf",width = 10, height = 5, onefile = FALSE)
dev.off()
...
tiff(filename = "D://4.生物信息//R//生信//CAD-2//plot//6.1cv_fit.tiff", res = 300, width = 2500, height = 1800,compression = "lzw")
dev.off()
pdf(file = "D://4.生物信息//R//生信//CAD-2//plot//6.1cv_fit.pdf",width = 12, height = 8, onefile = FALSE)
dev.off()
tiff(filename = "D://4.生物信息//R//生信//CAD-2//plot//6.2lambda.tiff", res = 300, width = 2500, height = 1800,compression = "lzw")
dev.off()
pdf(file = "D://4.生物信息//R//生信//CAD-2//plot//6.2lambda.pdf",width = 12, height = 8, onefile = FALSE)
dev.off()
tiff(filename = "D://4.生物信息//R//生信//CAD-2//plot//6.3lasso_mod.tiff", res = 300, width = 2500, height = 1800,compression = "lzw")
dev.off()
pdf(file = "D://4.生物信息//R//生信//CAD-2//plot//6.3lasso_mod.pdf",width = 12, height = 8, onefile = FALSE)
dev.off()
...
tiff(filename = "D://4.生物信息//R//生信//CAD-2//plot//6.4logistic.tiff", res = 300, width = 2500, height = 1800,compression = "lzw")
dev.off()
pdf(file = "D://4.生物信息//R//生信//CAD-2//plot//6.4logistic.pdf",width = 12, height = 8, onefile = FALSE)
dev.off()
...
tiff(filename = "D://4.生物信息//R//生信//CAD-2//plot//7.1.1ssgsea_box.tiff", res = 300, width = 5000, height = 1800,compression = "lzw")
dev.off()
pdf(file = "D://4.生物信息//R//生信//CAD-2//plot//7.1.1ssgsea_box.pdf",width = 18, height = 8, onefile = FALSE)
dev.off()
tiff(filename = "D://4.生物信息//R//生信//CAD-2//plot//7.1.2ssgsea_heat.tiff", res = 300, width = 3500, height = 1800,compression = "lzw")
dev.off()
pdf(file = "D://4.生物信息//R//生信//CAD-2//plot//7.1.2ssgsea_heat.pdf",width = 12, height = 8, onefile = FALSE)
dev.off()
tiff(filename = "D://4.生物信息//R//生信//CAD-2//plot//7.1.3ssgsea_gene.tiff", res = 300, width = 3500, height = 1800,compression = "lzw")
dev.off()
pdf(file = "D://4.生物信息//R//生信//CAD-2//plot//7.1.3ssgsea_gene.pdf",width = 12, height = 8, onefile = FALSE)
dev.off()
...
estimate <- function(dat,pro){
  ...
  estimateScore(input.ds = output.f,
                output.ds=output.ds,
                platform="affymetrix")   ## 注意platform
...
tiff(filename = "D://4.生物信息//R//生信//CAD-2//plot//7.2.1estimate.tiff", res = 300, width = 3500, height = 1800,compression = "lzw")
dev.off()
pdf(file = "D://4.生物信息//R//生信//CAD-2//plot//7.2.1estimate.pdf",width = 12, height = 8, onefile = FALSE)
dev.off()
...
tiff(filename = "D://4.生物信息//R//生信//CAD-2//plot//7.3Cibersort.tiff", res = 300, width = 5000, height = 1800,compression = "lzw")
dev.off()
pdf(file = "D://4.生物信息//R//生信//CAD-2//plot//7.3Cibersort.pdf",width = 15, height = 8, onefile = FALSE)
dev.off()
...
immuCell_result
tiff(filename = "D://4.生物信息//R//生信//CAD-2//plot//8.1immucellai.tiff", res = 300, width = 1500, height = 1800,compression = "lzw")
dev.off()
pdf(file = "D://4.生物信息//R//生信//CAD-2//plot//8.1immucellai.pdf",width = 8,height = 8,onefile = FALSE)
dev.off()
...
easier_polt = ggplot(dat = easier_derived_scores,aes(Group,easier_score))+
  ...
  labs(title = "Easier")
easier_polt
tiff(filename = "D://4.生物信息//R//生信//CAD-2//plot//8.2easier.tiff", res = 300, width = 1500, height = 1800,compression = "lzw")
dev.off()
pdf(file = "D://4.生物信息//R//生信//CAD-2//plot//8.2easier.pdf",width = 8,height = 8,onefile = FALSE)
dev.off()
tiff(filename = "D://4.生物信息//R//生信//CAD-2//plot//8.3treat.tiff", res = 300, width = 2500, height = 1800,compression = "lzw")
immuCell_result + easier_polt
dev.off()
pdf(file = "D://4.生物信息//R//生信//CAD-2//plot//8.3treat.pdf",width = 8,height = 8,onefile = FALSE)
immuCell_result + easier_polt
dev.off()
...
tiff(filename = "D://4.生物信息//R//生信//CAD-2//plot//5.1GO(bar).tiff", res = 300, width = 2500, height = 1800,compression = "lzw")
dev.off()
pdf(file = "D://4.生物信息//R//生信//CAD-2//plot//5.1GO(bar).pdf",width = 12, height = 8, onefile = FALSE)
dev.off()
tiff(filename = "D://4.生物信息//R//生信//CAD-2//plot//5.1GO(dot).tiff", res = 300, width = 2500, height = 1800,compression = "lzw")
dev.off()
pdf(file = "D://4.生物信息//R//生信//CAD-2//plot//5.1GO(dot).pdf",width = 12, height = 8, onefile = FALSE)
dev.off()
tiff(filename = "D://4.生物信息//R//生信//CAD-2//plot//5.1GO(dot_3).tiff", res = 300, width = 2500, height = 1800,compression = "lzw")
dev.off()
pdf(file = "D://4.生物信息//R//生信//CAD-2//plot//5.1GO(dot_3).pdf",width = 12, height = 8, onefile = FALSE)
dev.off()
tiff(filename = "D://4.生物信息//R//生信//CAD-2//plot//5.2Concept.tiff", res = 300, width = 5000, height = 3500,compression = "lzw")
dev.off()
pdf(file = "D://4.生物信息//R//生信//CAD-2//plot//5.2Concept.pdf",width = 15, height = 12, onefile = FALSE)
dev.off()
tiff(filename = "D://4.生物信息//R//生信//CAD-2//plot//5.2Concept_cir.tiff", res = 300, width = 3500, height = 2500,compression = "lzw")
dev.off()
pdf(file = "D://4.生物信息//R//生信//CAD-2//plot//5.2Concept_cir.pdf",width = 15, height = 12, onefile = FALSE)
dev.off()
tiff(filename = "D://4.生物信息//R//生信//CAD-2//plot//5.3GO_pathway_BP.tiff", res = 300, width = 5000, height = 3500,compression = "lzw")
dev.off()
tiff(filename = "D://4.生物信息//R//生信//CAD-2//plot//5.3GO_pathway_CC.tiff", res = 300, width = 4000, height = 2800,compression = "lzw")
dev.off()
tiff(filename = "D://4.生物信息//R//生信//CAD-2//plot//5.3GO_pathway_MF.tiff", res = 300, width = 3500, height = 2500,compression = "lzw")
dev.off()
tiff(filename = "D://4.生物信息//R//生信//CAD-2//plot//5.4Pathway_gene(heat).tiff", res = 300, width = 5500, height = 2800,compression = "lzw")
dev.off()
pdf(file = "D://4.生物信息//R//生信//CAD-2//plot//5.4Pathway_gene(heat).pdf",width = 18, height = 8, onefile = FALSE)
dev.off()
tiff(filename = "D://4.生物信息//R//生信//CAD-2//plot//5.5kegg.tiff", res = 300, width = 2500, height = 1800,compression = "lzw")
dev.off()
pdf(file = "D://4.生物信息//R//生信//CAD-2//plot//5.5kegg.pdf",width = 12, height = 8, onefile = FALSE)
dev.off()
tiff(filename = "D://4.生物信息//R//生信//CAD-2//plot//5.6gsea.tiff", res = 300, width = 2500, height = 1800,compression = "lzw")
dev.off()
pdf(file = "D://4.生物信息//R//生信//CAD-2//plot//5.6gsea.pdf",width = 12, height = 8, onefile = FALSE)
dev.off()
...
tiff(filename = "D://4.生物信息//R//生信//CAD-2//plot//9.exp.tiff", res = 300, width = 5000, height = 1500,compression = "lzw")
dev.off()
pdf(file = "D://4.生物信息//R//生信//CAD-2//plot//9.exp.pdf",width = 18, height = 5, onefile = FALSE)
dev.off()
...
tiff(filename = "D://4.生物信息//R//生信//CAD-2//plot//9.2gene_cor.tiff", res = 300, width = 3000, height = 2000,compression = "lzw")
cor_plot
dev.off()
pdf(file = "D://4.生物信息//R//生信//CAD-2//plot//9.2gene_cor.pdf",width = 12, height = 8, onefile = FALSE)
cor_plot
dev.off()
tiff(filename = "D://4.生物信息//R//生信//CAD-2//plot//9.3gene_cor_cir.tiff", res = 300, width = 3000, height = 2000,compression = "lzw")
dev.off()
pdf(file = "D://4.生物信息//R//生信//CAD-2//plot//9.3gene_cor_cir.pdf",width = 12, height = 8, onefile = FALSE)
dev.off()
...
load("step1_data.Rdata")
g <- c("HIST1H4E","IL6ST","RN7SKP45","LST1","SNORD50B")
sgene="SNORD50B"       #输入进行单基因GSEA的基因名称
...
gseaplot2(kk2,
          ...
          "hsa00260", #绘制hsa04658通路的结果，通路名称与编号对应
          color="red", #线条颜色
          base_size = 20, #基础字体的大小
          subplots = 1:3, 
          pvalue_table = T) # 显示p值
tiff(filename = "D://4.生物信息//R//生信//CAD-2//plot//10.5SNORD50B.tiff", res = 300, width = 3000, height = 2000,compression = "lzw")
dev.off()
pdf(file = "D://4.生物信息//R//生信//CAD-2//plot//10.5SNORD50B.pdf",width = 12, height = 8, onefile = FALSE)
dev.off()
...
mantel <- mantel_test(varespec, varechem,
  ...
  mutate(rd = cut(r, breaks = c(-Inf, 0.4, 0.6, Inf), 
                  labels = c("< 0.4", "0.4 - 0.6", ">= 0.6")),#定义Mantel的R值范围标签，便于出图 
         pd = cut(p.value, breaks = c(-Inf, 0.01, 0.05, Inf), 
                  labels = c("< 0.01", "0.01 - 0.05", ">= 0.05")))#定义Mantel检验的p值范围标签，便于出图 
a <- quickcor(varechem, type = "upper") +#绘制理化数据热图 
...
tiff(filename = "D://4.生物信息//R//生信//CAD-2//plot//13.1inhibitor.tiff", res = 300, width = 4000, height = 3000,compression = "lzw")
a
dev.off()
pdf(file = "D://4.生物信息//R//生信//CAD-2//plot//13.1inhibitor.pdf",width = 12, height = 8, onefile = FALSE)
a
dev.off()
...
mantel <- mantel_test(varespec, varechem.1,
  ...
  mutate(rd = cut(r, breaks = c(-Inf, 0.4, 0.6, Inf), 
         ...
         pd = cut(p.value, breaks = c(-Inf, 0.01, 0.05, Inf), 
                  labels = c("< 0.01", "0.01 - 0.05", ">= 0.05")))#定义Mantel检验的p值范围标签，便于出图 
b <- quickcor(varechem.1, type = "upper") +#绘制理化数据热图 
  scale_fill_gradient2(low="#2fa1dd", high="#f87669", mid="white")+
  geom_star()+ #定义成圆 
  anno_link(aes(colour = pd, size = rd), data = mantel) +#定义连线 
  scale_size_manual(values = c(0.5, 1, 2))+ 
  ...
  guides(size = guide_legend(title = "Mantel's r",#定义图例 
         ...
         colour = guide_legend(title = "Mantel's p",  
                               order = 3), 
         fill = guide_colorbar(title = "Pearson's r", order = 4)) 
tiff(filename = "D://4.生物信息//R//生信//CAD-2//plot//13.2stimulator.tiff", res = 300, width = 4000, height = 3000,compression = "lzw")
b
dev.off()
pdf(file = "D://4.生物信息//R//生信//CAD-2//plot//13.2stimulator.pdf",width = 15, height = 10, onefile = FALSE)
b
dev.off()
...
mantel <- mantel_test(varespec, varechem.2,
  ...
  mutate(rd = cut(r, breaks = c(-Inf, 0.4, 0.6, Inf), 
         ...
         pd = cut(p.value, breaks = c(-Inf, 0.01, 0.05, Inf), 
                  labels = c("< 0.01", "0.01 - 0.05", ">= 0.05")))#定义Mantel检验的p值范围标签，便于出图 
c <- quickcor(varechem.2, type = "upper") +#绘制理化数据热图 
  scale_fill_gradient2(low="#2fa1dd", high="#f87669", mid="white")+
  geom_star()+ #定义成圆 
  anno_link(aes(colour = pd, size = rd), data = mantel) +#定义连线 
  scale_size_manual(values = c(0.5, 1, 2))+ 
  ...
  guides(size = guide_legend(title = "Mantel's r",#定义图例 
         ...
         colour = guide_legend(title = "Mantel's p",  
                               order = 3), 
         fill = guide_colorbar(title = "Pearson's r", order = 4)) 
tiff(filename = "D://4.生物信息//R//生信//CAD-2//plot//13.3MHC.tiff", res = 300, width = 4000, height = 3000,compression = "lzw")
c
dev.off()
pdf(file = "D://4.生物信息//R//生信//CAD-2//plot//13.3MHC.pdf",width = 12, height = 8, onefile = FALSE)
c
dev.off()
...
p4
p1 + p4 + p2 + p3
tiff(filename = "D://4.生物信息//R//生信//CAD-2//plot//13.4cor.tiff", res = 300, width = 4000, height = 3000,compression = "lzw")
p1 + p4 + p2 + p3
dev.off()
pdf(file = "D://4.生物信息//R//生信//CAD-2//plot//13.4cor.pdf",width = 12, height = 8, onefile = FALSE)
p1 + p4 + p2 + p3
dev.off()
